...
**0.5.1** — synced across all surfaces:

| Surface | Version | Check |
|---------|---------|-------|
| `package.json` | 0.5.1 | `node -e "console.log(require('./package.json').version)"` |
| MCP server (`mcp/entry.ts`) | 0.5.1 | `grep version mcp/entry.ts` |
| Global npm install | 0.5.1 | `npm ls -g pi-shazam` |
| GitHub Release | v0.5.1 | `gh release view v0.5.1` |
| Git tag | v0.5.1 | `git describe --tags` |
| npm registry | 0.5.1 | `npm view pi-shazam version` |
